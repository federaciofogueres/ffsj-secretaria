...
export class AppComponent implements OnInit, OnDestroy {
  ...
  readonly navLinks = [
    ...
    { path: '/solicitudes-modificacion-asociacion', label: 'Cambios de asociación', icon: 'bi-building-check', permission: 'admin:access', adminOnly: true },
  ...
  get tareas(): PendingTask[] {
    ...
    return ([
      ...
      { title: 'Certificaciones pendientes', count: this.associationSummary.autorizacionesAltaPendientes || 0, icon: 'bi-pen-fill', path: '/registro/documentacion' },
