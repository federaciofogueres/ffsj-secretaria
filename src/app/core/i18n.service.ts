...
Object.assign(translations.es, {
  ...
  'rubi.admin.analytics.noData': 'Todavia no hay datos suficientes para este periodo.',
  'rubi.admin.analytics.funnelTitle': 'Funnel por workflow', 'rubi.admin.analytics.funnel.started': 'Iniciados', 'rubi.admin.analytics.funnel.prepared': 'Preparados',
  'rubi.admin.analytics.funnel.completed': 'Completados', 'rubi.admin.analytics.funnel.cancelled': 'Cancelados', 'rubi.admin.analytics.funnel.failed': 'Fallidos',
  'rubi.admin.analytics.funnel.redirected': 'Derivados al flujo normal', 'rubi.admin.analytics.funnel.expired': 'Caducados',
  'rubi.admin.analytics.conversationalTitle': 'Analytics conversacional', 'rubi.admin.analytics.byIntent': 'Por intent', 'rubi.admin.analytics.bySource': 'Por source',
  'rubi.admin.analytics.reformulations': 'Posibles reformulaciones',
  'rubi.admin.analytics.feedbackTitle': 'Feedback', 'rubi.admin.analytics.helpful': 'Util (👍)', 'rubi.admin.analytics.notHelpful': 'No util (👎)',
  'rubi.admin.analytics.byReason': 'Por motivo', 'rubi.admin.analytics.byReasonIntent': 'Motivo por intent', 'rubi.admin.analytics.byReasonTool': 'Motivo por tool', 'rubi.admin.analytics.byReasonFlow': 'Motivo por flow',
  'rubi.admin.analytics.qualityTitle': 'Calidad', 'rubi.admin.analytics.quality.unknownIntent': 'Intent desconocido', 'rubi.admin.analytics.quality.reformulation': 'Posible reformulacion',
  'rubi.admin.analytics.quality.helpful': 'Satisfaccion (👍)', 'rubi.admin.analytics.quality.flowCompletion': 'Completado de workflows', 'rubi.admin.analytics.quality.flowCancellation': 'Cancelacion de workflows',
  'rubi.admin.analytics.quality.providerUsage': 'Uso del provider',
  'rubi.admin.analytics.trendsTitle': 'Tendencias', 'rubi.admin.analytics.trendsHint': 'Periodo anterior comparado',
  'rubi.admin.analytics.trends.vs': 'frente a', 'rubi.admin.analytics.trends.cancellation': 'Cancelacion', 'rubi.admin.analytics.trends.providerLatency': 'Latencia del provider',
  'rubi.admin.suggestions.title': 'Sugerencias', 'rubi.admin.suggestions.hint': 'Detectadas de forma determinista a partir de la analitica; el texto solo interpreta esos mismos datos, nunca los sustituye.',
  'rubi.admin.suggestions.filter.open': 'Abiertas', 'rubi.admin.suggestions.filter.discarded': 'Descartadas', 'rubi.admin.suggestions.filter.closed': 'Cerradas',
  'rubi.admin.suggestions.analyze': 'Analizar ahora', 'rubi.admin.suggestions.empty': 'No hay sugerencias en este filtro.',
  'rubi.admin.suggestions.col.status': 'Estado', 'rubi.admin.suggestions.col.suggestion': 'Sugerencia', 'rubi.admin.suggestions.col.evidence': 'Evidencia',
  'rubi.admin.suggestions.col.priority': 'Prioridad', 'rubi.admin.suggestions.col.confidence': 'Confianza',
  'rubi.admin.suggestions.detail.close': 'Cerrar ficha', 'rubi.admin.suggestions.detail.whatDetected': 'Que ha detectado',
  'rubi.admin.suggestions.detail.why': 'Por que', 'rubi.admin.suggestions.detail.sample': 'Muestra', 'rubi.admin.suggestions.detail.timesDetected': 'Veces detectada',
  'rubi.admin.suggestions.detail.comparison': 'Comparacion', 'rubi.admin.suggestions.detail.current': 'Actual', 'rubi.admin.suggestions.detail.baseline': 'periodo anterior',
  'rubi.admin.suggestions.detail.noData': 'sin dato', 'rubi.admin.suggestions.detail.measurement': 'Medicion posterior',
  'rubi.admin.suggestions.detail.before': 'Antes', 'rubi.admin.suggestions.detail.after': 'Despues', 'rubi.admin.suggestions.detail.change': 'Cambio',
  'rubi.admin.suggestions.detail.measurementHint': 'La mejora coincide temporalmente con el cambio implementado; no se afirma causalidad absoluta.',
  'rubi.admin.suggestions.detail.proposal': 'Que propone', 'rubi.admin.suggestions.detail.impact': 'Impacto esperado (hipotesis)',
  'rubi.admin.suggestions.detail.actions': 'Acciones administrativas', 'rubi.admin.suggestions.detail.terminal': 'Esta sugerencia ya no admite mas acciones.',
  'rubi.admin.suggestions.action.review': 'Marcar en revision', 'rubi.admin.suggestions.action.accept': 'Aceptar', 'rubi.admin.suggestions.action.discard': 'Descartar',
  'rubi.admin.suggestions.action.implement': 'Marcar implementada', 'rubi.admin.suggestions.action.close': 'Cerrar',
  'rubi.admin.suggestions.action.discardReasonPlaceholder': 'Motivo del descarte (obligatorio)',
  'rubi.admin.suggestions.action.attachBenchmark': 'Adjuntar evidencia de benchmark', 'rubi.admin.suggestions.action.cancelBenchmark': 'Cancelar',
  'rubi.admin.suggestions.detail.benchmark': 'Evidencia de benchmark', 'rubi.admin.suggestions.detail.benchmarkNone': 'Todavia no se ha adjuntado ningun benchmark a esta sugerencia.',
  'rubi.admin.suggestions.detail.benchmarkAttachedAt': 'Adjuntada el', 'rubi.admin.suggestions.detail.benchmarkCostDelta': 'Variacion de coste estimada',
  'rubi.admin.suggestions.benchmark.baseline': 'Modelo base', 'rubi.admin.suggestions.benchmark.candidate': 'Modelo candidato',
  'rubi.admin.suggestions.benchmark.provider': 'Proveedor', 'rubi.admin.suggestions.benchmark.model': 'Modelo',
  'rubi.admin.suggestions.benchmark.metric': 'Metrica', 'rubi.admin.suggestions.benchmark.metricPlaceholder': 'p.ej. not_understood_rate',
  'rubi.admin.suggestions.benchmark.baselineValue': 'Valor base', 'rubi.admin.suggestions.benchmark.candidateValue': 'Valor candidato',
  'rubi.admin.suggestions.benchmark.costDelta': 'Variacion de coste (%)', 'rubi.admin.suggestions.benchmark.notes': 'Notas',
  'rubi.admin.suggestions.benchmark.save': 'Guardar evidencia',
  'rubi.admin.suggestions.benchmark.hint': 'El benchmark se ejecuta antes y aparte, en local (npm run rubi:eval:matrix); aqui solo se adjunta el resumen ya calculado, nunca el informe completo.',
  'rubi.admin.error.suggestions': 'No se han podido cargar las sugerencias.', 'rubi.admin.error.suggestionsAnalyze': 'No se ha podido ejecutar el analisis de sugerencias.',
  'rubi.admin.error.suggestionAction': 'No se ha podido actualizar el estado de la sugerencia.',
  'rubi.admin.error.suggestionBenchmark': 'No se ha podido adjuntar la evidencia de benchmark.',
...
Object.assign(translations.va, {
  ...
  'rubi.admin.analytics.noData': 'Encara no hi ha dades suficients per a aquest periode.',
  'rubi.admin.analytics.funnelTitle': 'Funnel per workflow', 'rubi.admin.analytics.funnel.started': 'Iniciats', 'rubi.admin.analytics.funnel.prepared': 'Preparats',
  'rubi.admin.analytics.funnel.completed': 'Completats', 'rubi.admin.analytics.funnel.cancelled': 'Cancel·lats', 'rubi.admin.analytics.funnel.failed': 'Fallits',
  'rubi.admin.analytics.funnel.redirected': 'Derivats al flux normal', 'rubi.admin.analytics.funnel.expired': 'Caducats',
  'rubi.admin.analytics.conversationalTitle': 'Analytics conversacional', 'rubi.admin.analytics.byIntent': 'Per intent', 'rubi.admin.analytics.bySource': 'Per source',
  'rubi.admin.analytics.reformulations': 'Possibles reformulacions',
  'rubi.admin.analytics.feedbackTitle': 'Feedback', 'rubi.admin.analytics.helpful': 'Util (👍)', 'rubi.admin.analytics.notHelpful': 'No util (👎)',
  'rubi.admin.analytics.byReason': 'Per motiu', 'rubi.admin.analytics.byReasonIntent': 'Motiu per intent', 'rubi.admin.analytics.byReasonTool': 'Motiu per tool', 'rubi.admin.analytics.byReasonFlow': 'Motiu per flow',
  'rubi.admin.analytics.qualityTitle': 'Qualitat', 'rubi.admin.analytics.quality.unknownIntent': 'Intent desconegut', 'rubi.admin.analytics.quality.reformulation': 'Possible reformulacio',
  'rubi.admin.analytics.quality.helpful': 'Satisfaccio (👍)', 'rubi.admin.analytics.quality.flowCompletion': 'Completat de workflows', 'rubi.admin.analytics.quality.flowCancellation': 'Cancel·lacio de workflows',
  'rubi.admin.analytics.quality.providerUsage': 'Us del provider',
  'rubi.admin.analytics.trendsTitle': 'Tendencies', 'rubi.admin.analytics.trendsHint': 'Periode anterior comparat',
  'rubi.admin.analytics.trends.vs': 'enfront de', 'rubi.admin.analytics.trends.cancellation': 'Cancel·lacio', 'rubi.admin.analytics.trends.providerLatency': 'Latencia del provider',
  'rubi.admin.suggestions.title': 'Suggeriments', 'rubi.admin.suggestions.hint': 'Detectats de forma determinista a partir de l analitica; el text nomes interpreta eixes mateixes dades, mai les substitueix.',
  'rubi.admin.suggestions.filter.open': 'Obertes', 'rubi.admin.suggestions.filter.discarded': 'Descartades', 'rubi.admin.suggestions.filter.closed': 'Tancades',
  'rubi.admin.suggestions.analyze': 'Analitzar ara', 'rubi.admin.suggestions.empty': 'No hi ha suggeriments en este filtre.',
  'rubi.admin.suggestions.col.status': 'Estat', 'rubi.admin.suggestions.col.suggestion': 'Suggeriment', 'rubi.admin.suggestions.col.evidence': 'Evidencia',
  'rubi.admin.suggestions.col.priority': 'Prioritat', 'rubi.admin.suggestions.col.confidence': 'Confianca',
  'rubi.admin.suggestions.detail.close': 'Tancar fitxa', 'rubi.admin.suggestions.detail.whatDetected': 'Que ha detectat',
  'rubi.admin.suggestions.detail.why': 'Per que', 'rubi.admin.suggestions.detail.sample': 'Mostra', 'rubi.admin.suggestions.detail.timesDetected': 'Voltes detectada',
  'rubi.admin.suggestions.detail.comparison': 'Comparacio', 'rubi.admin.suggestions.detail.current': 'Actual', 'rubi.admin.suggestions.detail.baseline': 'periode anterior',
  'rubi.admin.suggestions.detail.noData': 'sense dada', 'rubi.admin.suggestions.detail.measurement': 'Mesura posterior',
  'rubi.admin.suggestions.detail.before': 'Abans', 'rubi.admin.suggestions.detail.after': 'Despres', 'rubi.admin.suggestions.detail.change': 'Canvi',
  'rubi.admin.suggestions.detail.measurementHint': 'La millora coincideix temporalment amb el canvi implementat; no s afirma causalitat absoluta.',
  'rubi.admin.suggestions.detail.proposal': 'Que proposa', 'rubi.admin.suggestions.detail.impact': 'Impacte esperat (hipotesi)',
  'rubi.admin.suggestions.detail.actions': 'Accions administratives', 'rubi.admin.suggestions.detail.terminal': 'Este suggeriment ja no admet mes accions.',
  'rubi.admin.suggestions.action.review': 'Marcar en revisio', 'rubi.admin.suggestions.action.accept': 'Acceptar', 'rubi.admin.suggestions.action.discard': 'Descartar',
  'rubi.admin.suggestions.action.implement': 'Marcar implementada', 'rubi.admin.suggestions.action.close': 'Tancar',
  'rubi.admin.suggestions.action.discardReasonPlaceholder': 'Motiu del descart (obligatori)',
  'rubi.admin.suggestions.action.attachBenchmark': 'Adjuntar evidencia de benchmark', 'rubi.admin.suggestions.action.cancelBenchmark': 'Cancelar',
  'rubi.admin.suggestions.detail.benchmark': 'Evidencia de benchmark', 'rubi.admin.suggestions.detail.benchmarkNone': 'Encara no s ha adjuntat cap benchmark a este suggeriment.',
  'rubi.admin.suggestions.detail.benchmarkAttachedAt': 'Adjuntada el', 'rubi.admin.suggestions.detail.benchmarkCostDelta': 'Variacio de cost estimada',
  'rubi.admin.suggestions.benchmark.baseline': 'Model base', 'rubi.admin.suggestions.benchmark.candidate': 'Model candidat',
  'rubi.admin.suggestions.benchmark.provider': 'Proveidor', 'rubi.admin.suggestions.benchmark.model': 'Model',
  'rubi.admin.suggestions.benchmark.metric': 'Metrica', 'rubi.admin.suggestions.benchmark.metricPlaceholder': 'p.ex. not_understood_rate',
  'rubi.admin.suggestions.benchmark.baselineValue': 'Valor base', 'rubi.admin.suggestions.benchmark.candidateValue': 'Valor candidat',
  'rubi.admin.suggestions.benchmark.costDelta': 'Variacio de cost (%)', 'rubi.admin.suggestions.benchmark.notes': 'Notes',
  'rubi.admin.suggestions.benchmark.save': 'Guardar evidencia',
  'rubi.admin.suggestions.benchmark.hint': 'El benchmark s executa abans i a banda, en local (npm run rubi:eval:matrix); aci nomes s adjunta el resum ja calculat, mai l informe complet.',
  'rubi.admin.error.suggestions': 'No s han pogut carregar els suggeriments.', 'rubi.admin.error.suggestionsAnalyze': 'No s ha pogut executar l analisi de suggeriments.',
  'rubi.admin.error.suggestionAction': 'No s ha pogut actualitzar l estat del suggeriment.',
  'rubi.admin.error.suggestionBenchmark': 'No s ha pogut adjuntar l evidencia de benchmark.',
...
Object.assign(translations.en, {
  ...
  'rubi.admin.analytics.noData': 'Not enough data yet for this period.',
  'rubi.admin.analytics.funnelTitle': 'Funnel by workflow', 'rubi.admin.analytics.funnel.started': 'Started', 'rubi.admin.analytics.funnel.prepared': 'Prepared',
  'rubi.admin.analytics.funnel.completed': 'Completed', 'rubi.admin.analytics.funnel.cancelled': 'Cancelled', 'rubi.admin.analytics.funnel.failed': 'Failed',
  'rubi.admin.analytics.funnel.redirected': 'Redirected to normal flow', 'rubi.admin.analytics.funnel.expired': 'Expired',
  'rubi.admin.analytics.conversationalTitle': 'Conversational analytics', 'rubi.admin.analytics.byIntent': 'By intent', 'rubi.admin.analytics.bySource': 'By source',
  'rubi.admin.analytics.reformulations': 'Possible reformulations',
  'rubi.admin.analytics.feedbackTitle': 'Feedback', 'rubi.admin.analytics.helpful': 'Helpful (👍)', 'rubi.admin.analytics.notHelpful': 'Not helpful (👎)',
  'rubi.admin.analytics.byReason': 'By reason', 'rubi.admin.analytics.byReasonIntent': 'Reason by intent', 'rubi.admin.analytics.byReasonTool': 'Reason by tool', 'rubi.admin.analytics.byReasonFlow': 'Reason by flow',
  'rubi.admin.analytics.qualityTitle': 'Quality', 'rubi.admin.analytics.quality.unknownIntent': 'Unknown intent', 'rubi.admin.analytics.quality.reformulation': 'Possible reformulation',
  'rubi.admin.analytics.quality.helpful': 'Satisfaction (👍)', 'rubi.admin.analytics.quality.flowCompletion': 'Workflow completion', 'rubi.admin.analytics.quality.flowCancellation': 'Workflow cancellation',
  'rubi.admin.analytics.quality.providerUsage': 'Provider usage',
  'rubi.admin.analytics.trendsTitle': 'Trends', 'rubi.admin.analytics.trendsHint': 'Previous period compared',
  'rubi.admin.analytics.trends.vs': 'vs', 'rubi.admin.analytics.trends.cancellation': 'Cancellation', 'rubi.admin.analytics.trends.providerLatency': 'Provider latency',
  'rubi.admin.suggestions.title': 'Suggestions', 'rubi.admin.suggestions.hint': 'Detected deterministically from the analytics; the text only interprets that same data, never replaces it.',
  'rubi.admin.suggestions.filter.open': 'Open', 'rubi.admin.suggestions.filter.discarded': 'Discarded', 'rubi.admin.suggestions.filter.closed': 'Closed',
  'rubi.admin.suggestions.analyze': 'Analyze now', 'rubi.admin.suggestions.empty': 'No suggestions for this filter.',
  'rubi.admin.suggestions.col.status': 'Status', 'rubi.admin.suggestions.col.suggestion': 'Suggestion', 'rubi.admin.suggestions.col.evidence': 'Evidence',
  'rubi.admin.suggestions.col.priority': 'Priority', 'rubi.admin.suggestions.col.confidence': 'Confidence',
  'rubi.admin.suggestions.detail.close': 'Close sheet', 'rubi.admin.suggestions.detail.whatDetected': 'What was detected',
  'rubi.admin.suggestions.detail.why': 'Why', 'rubi.admin.suggestions.detail.sample': 'Sample', 'rubi.admin.suggestions.detail.timesDetected': 'Times detected',
  'rubi.admin.suggestions.detail.comparison': 'Comparison', 'rubi.admin.suggestions.detail.current': 'Current', 'rubi.admin.suggestions.detail.baseline': 'previous period',
  'rubi.admin.suggestions.detail.noData': 'no data', 'rubi.admin.suggestions.detail.measurement': 'Post-implementation measurement',
  'rubi.admin.suggestions.detail.before': 'Before', 'rubi.admin.suggestions.detail.after': 'After', 'rubi.admin.suggestions.detail.change': 'Change',
  'rubi.admin.suggestions.detail.measurementHint': 'The improvement coincides in time with the implemented change; this is not a claim of absolute causality.',
  'rubi.admin.suggestions.detail.proposal': 'What it proposes', 'rubi.admin.suggestions.detail.impact': 'Expected impact (hypothesis)',
  'rubi.admin.suggestions.detail.actions': 'Administrative actions', 'rubi.admin.suggestions.detail.terminal': 'This suggestion no longer accepts further actions.',
  'rubi.admin.suggestions.action.review': 'Mark under review', 'rubi.admin.suggestions.action.accept': 'Accept', 'rubi.admin.suggestions.action.discard': 'Discard',
  'rubi.admin.suggestions.action.implement': 'Mark implemented', 'rubi.admin.suggestions.action.close': 'Close',
  'rubi.admin.suggestions.action.discardReasonPlaceholder': 'Reason for discarding (required)',
  'rubi.admin.suggestions.action.attachBenchmark': 'Attach benchmark evidence', 'rubi.admin.suggestions.action.cancelBenchmark': 'Cancel',
  'rubi.admin.suggestions.detail.benchmark': 'Benchmark evidence', 'rubi.admin.suggestions.detail.benchmarkNone': 'No benchmark has been attached to this suggestion yet.',
  'rubi.admin.suggestions.detail.benchmarkAttachedAt': 'Attached on', 'rubi.admin.suggestions.detail.benchmarkCostDelta': 'Estimated cost change',
  'rubi.admin.suggestions.benchmark.baseline': 'Baseline model', 'rubi.admin.suggestions.benchmark.candidate': 'Candidate model',
  'rubi.admin.suggestions.benchmark.provider': 'Provider', 'rubi.admin.suggestions.benchmark.model': 'Model',
  'rubi.admin.suggestions.benchmark.metric': 'Metric', 'rubi.admin.suggestions.benchmark.metricPlaceholder': 'e.g. not_understood_rate',
  'rubi.admin.suggestions.benchmark.baselineValue': 'Baseline value', 'rubi.admin.suggestions.benchmark.candidateValue': 'Candidate value',
  'rubi.admin.suggestions.benchmark.costDelta': 'Cost change (%)', 'rubi.admin.suggestions.benchmark.notes': 'Notes',
  'rubi.admin.suggestions.benchmark.save': 'Save evidence',
  'rubi.admin.suggestions.benchmark.hint': 'The benchmark runs beforehand, separately and locally (npm run rubi:eval:matrix); this only attaches the already-computed summary, never the full report.',
  'rubi.admin.error.suggestions': 'Could not load suggestions.', 'rubi.admin.error.suggestionsAnalyze': 'Could not run the suggestion analysis.',
  'rubi.admin.error.suggestionAction': 'Could not update the suggestion status.',
  'rubi.admin.error.suggestionBenchmark': 'Could not attach the benchmark evidence.',
